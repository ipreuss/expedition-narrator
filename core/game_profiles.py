...
GAME_PROFILES: Dict[str, GameProfile] = {
    "aeons_end": GameProfile(
        ...
        implemented=True,
        instruction_location="gpt/system_prompt.txt plus gpt/common/*.txt and gpt/aeons_end/*.txt",
    ...
    "astro_knights": GameProfile(
        ...
        implemented=True,
        instruction_location="gpt/system_prompt.txt plus gpt/common/*.txt and gpt/astro_knights/*.txt",
